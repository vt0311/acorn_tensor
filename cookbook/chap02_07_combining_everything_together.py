...
# 붓꽃 데이터섹 분류기
# 어떤 꽃이 setosa 인지 아닌지를 판단
# 꽃잎의 길이와 너비만을 이용하여 setosa 종인지 아닌지를 구분하는 예시
#----------------------------------
...
for i in range(1000):
    # iris : 쿡북 51쪽 참고
    # iris 데이터는 150개의 행을 가지고 있다.
    # 150개에서 20개씩 임의의 복원 추출
...
[[intercept]] = sess.run(b) # y 절편

# Create fitted line
x = np.linspace(0, 3, num=50)

# 직선을 그리기 위한 점 정보를 담고 있는 리스트
ablineValues = []
